...
#### Install `snapcraft` on your machine (If ubuntu it comes by defeault)

#### Download & install `golang` in your system by visiting `https://go.dev`

#### run `make build` in order to build package locally
